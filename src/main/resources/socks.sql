...
/*Table structure for table `t_user_new` */

DROP TABLE IF EXISTS `t_user_new`;
...
/*Data for the table `t_user_new` */

insert  into `t_user_new`(`USER_ID`,`USERNAME`,`PASSWORD`,`PHONE_NUM`) values ('1','admin','admin','15011791234'),('2','roots','roots','18812342017');
